...
from app.prom.metrics.general.sysmetric import SysMetric, METRIC_NAME, VALUE
from tests.helpers import setUpApp, with_context


class TestSysMetric(TestCase):
    ...
    def test_should_collect(self):
        ...
        sysmetric.collect(self.app, rows=(_ for _ in [test_data_1, test_data_2]))
